/* 
 * File:   your_account_page_javascript_jquery.js
 * Author: Benjamin Silveston
 *
 * Created on 01 May 2014, 11:27
 * 
 * JavaScript/jQuery document for the your_account_page.php file
 */
...
$(document).ready(function() {
	...
	/* Altering the view account page link colour */
	$('#view_account_page_link').mouseenter(function() {
		$(this).css("color", "red");
	});
	$('#view_account_page_link').mouseleave(function() {
		$(this).css("color", "black");
	});
	/* Altering the edit account page link colour */
	$('#edit_account_page_link').mouseenter(function() {
		$(this).css("color", "red");
	});
	$('#edit_account_page_link').mouseleave(function() {
		$(this).css("color", "black");
	});
/* Altering the delete account page link colour */
	$('#delete_account_page_link').mouseenter(function() {
		$(this).css("color", "red");
	});
	$('#delete_account_page_link').mouseleave(function() {
		$(this).css("color", "black");
	});	
});