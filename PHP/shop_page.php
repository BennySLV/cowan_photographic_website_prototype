...
<link type="text/css" rel="stylesheet" href="../CSS/shop_page_stylesheet.css" />
...
<script type="text/javascript" src="../JavaScript/shop_page_javascript_jquery.js"></script>
<title>Shop | Cowan Photographic</title>
</head>
<body>
<!--Menu banner-->
    ...
    <div class="content_intro">
      	<h3 id="contact_title" align="center"><strong>Shop</strong></h3>
    </div>
    <br/>
<?php
